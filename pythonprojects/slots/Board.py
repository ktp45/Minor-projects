...
class Board:  # the slots machine display made by 5 columns each an equal list
    def __init__(self, list1=Linkedlist.CircularlinkedList()):
        self.l1 = Linkedlist.CircularlinkedList()
        self.l2 = Linkedlist.CircularlinkedList()
        self.l3 = Linkedlist.CircularlinkedList()
        self.l4 = Linkedlist.CircularlinkedList()
        self.l5 = Linkedlist.CircularlinkedList()
