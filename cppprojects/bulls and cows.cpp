...
void play()
{
	...
	{
		if (isValid(i))
			count++;  //  broika na vs validni chisla
	}
...
int main()
{
cout << "Namislete 4-cifreno chislo s razlichni cifri bez 0, programata shte go poznae do 7 opita" << endl;
cout << "Pri vseki opit bik e chislo koeto si e na mqstoto i e vqrno, a krava, samo vqrno." << endl;
play();
}
